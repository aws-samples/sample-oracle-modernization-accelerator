...
python3 "SQLPattern_analyzer.py" "$OUTPUT_DIR/java_files_list.txt" "$OUTPUT_DIR/sql_patterns.csv"

echo "Step 3: 대문자를 소문자로 변환 중..."
python3 "Convert_case.py" "$OUTPUT_DIR/sql_patterns.csv" "$OUTPUT_DIR/backups"
