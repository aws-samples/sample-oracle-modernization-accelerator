...
create_postgresql_service_user() {
    ...
    GRANT_CREATE_DB_SQL="GRANT CREATE ON DATABASE \"$db_name\" TO \"$PG_SVC_USER\";"
    GRANT_USAGE_SQL="GRANT USAGE ON SCHEMA public TO \"$PG_SVC_USER\";"
    GRANT_CREATE_SQL="GRANT CREATE ON SCHEMA public TO \"$PG_SVC_USER\";"
    GRANT_CREATE_SCHEMA_SQL="GRANT CREATE ON SCHEMA public TO \"$PG_SVC_USER\";"
