/*
 * This Workshop includes JPetStore which is licensed under the Apache License 2.0.
 * Copyright (c) The Apache Software Foundation
 *
 * This workshop content contains modifications to the original JPetStore application,
 * specifically for database testing purposes. These modifications are also licensed 
 * under the Apache License 2.0.
 *
 * For the complete Apache License 2.0 terms and conditions, please visit:
