...
[빠른 시작하기](#빠른-시작){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
...
- [**OMA Introduction**](OMA-Introduction.html): 프로젝트 개요 및 아키텍처
- [**Pre-Requisites**](Pre-Requisites.html): 인프라 구성 및 환경 설정

### 단계별 가이드
{: .text-delta }

#### ⚙️ 환경 설정 (0단계)
- [**0-1. 환경 설정 수행**](0-1.setEnv.html): 환경 변수 설정
- [**0-2. 환경 설정 확인**](0-2.checkEnv.html): 환경 설정 확인

#### 🔍 애플리케이션 분석 (1단계)
- [**1-1. 애플리케이션 분석**](1-1.processAppAnalysis.html): 애플리케이션 코드 분석
- [**1-2. 분석 보고서 작성**](1-2.processAppReporting.html): 분석 결과 리포팅
- [**1-3. 메타데이터 생성**](1-3.genPostgreSqlMeta.html): PostgreSQL/MySQL 메타데이터 생성

#### 🔄 코드 변환 (2단계)
- [**2-1. SQL 변환 처리**](2-1.processSqlTransform.html): SQL 변환 처리
- [**2-2. 변환 후 처리**](2-2.processPostTransform.html): 변환 후 처리

#### 🧪 SQL Unit Test (3단계)
- [**3-1. SQL Unit Test**](3-1.sqlUnitTest.html): 변환된 SQL 구문의 단위 테스트

#### 📊 결과 통합 (4단계)
- [**4-1. 변환 결과 병합**](4-1.processSqlTransformMerge.html): 변환 결과 병합
- [**4-2. 최종 리포트 생성**](4-2.processSqlTransformReport.html): 최종 리포트 생성
- [**4-3. Java Source 변환**](4-3.processJavaTransform.html): 애플리케이션 Java Source 변환 작업

#### 🔧 UI 오류 수정 (5단계)
- [**5-1. UI 오류-XML 재수정**](5-1.processUIErrorXMLFix.html): UI 관련 XML 오류 재수정 작업

### 추가 리소스
{: .text-delta }

- [**유용한 툴들**](useful-tools.html): OMA 프로젝트에서 활용할 수 있는 도구들
...
{: .highlight }
> **시작하기 전에**: [Pre-Requisites](Pre-Requisites.html) 문서를 먼저 확인하여 필요한 인프라와 환경을 구성하세요.
