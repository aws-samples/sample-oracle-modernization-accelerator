...
```
/home/ec2-user/workspace/sample-oracle-modernization-accelerator/your-application/test/
├── xmllist/                    # XML 파일 목록
...
```bash
# 환경 변수 자동 설정
source /home/ec2-user/workspace/sample-oracle-modernization-accelerator/bin/oma_env_your-application.sh
...
- **XML 리스트 파일:** `${APP_TRANSFORM_FOLDER}/xmllist/`
  ...
  - `tgt.list` - 타겟 XML 파일 목록
  - `postgres.list` - PostgreSQL용 XML 파일 목록
- **실제 경로:** `/home/ec2-user/workspace/sample-oracle-modernization-accelerator/your-application/test/xmllist/`
...
- **타겟 SQL 추출:** `${TEST_FOLDER}/tgt_sql_extract/`
  - 실제 경로: `/home/ec2-user/workspace/sample-oracle-modernization-accelerator/your-application/test/tgt_sql_extract/`
  - 파일 형식: `[매퍼네임스페이스].[SQL ID].sql`
...
```
# 소스 SQL 추출 결과
/home/ec2-user/workspace/sample-oracle-modernization-accelerator/your-application/test/src_sql_extract/
...
# 타겟 SQL 추출 결과
/home/ec2-user/workspace/sample-oracle-modernization-accelerator/your-application/test/tgt_sql_extract/
├── com.example.batch.BatchJobDao.selectBatchJob.sql
├── com.example.batch.BatchJobDao.insertBatchJob.sql
├── com.example.common.CommonDao.selectCommonCode.sql
└── ...
...
✅ TEST_FOLDER: /home/ec2-user/workspace/sample-oracle-modernization-accelerator/your-application/test
✅ APP_TRANSFORM_FOLDER: /home/ec2-user/workspace/sample-oracle-modernization-accelerator/your-application/application/transform
============================================================
XML 파일 목록 처리 중...
============================================================
...
- **딕셔너리 저장:** `${TEST_FOLDER}/dictionary/`
  - 실제 경로: `/home/ec2-user/workspace/sample-oracle-modernization-accelerator/your-application/test/dictionary/`
  - 주요 파일: `all_dictionary.json`
- **로그 저장:** `${TEST_LOGS_FOLDER}/`
  - 실제 경로: `/home/ec2-user/workspace/sample-oracle-modernization-accelerator/your-application/logs/test/`
