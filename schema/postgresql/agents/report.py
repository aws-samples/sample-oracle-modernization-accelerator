...
SYSTEM_PROMPT = """\
You are the **Report Agent** for Oracle-to-PostgreSQL migration.
...
2. **Assemble the complete JSON** for `generate_html_report` with ALL fields:
   ```json
   {
     ...
     "target": {"type": "PostgreSQL", "host": "...", "database": "..."},
     ...
     "issues_encountered": [
       {"phase": "verify", "description": "pg_syntax_check timeout on PROC_CALC_BONUS",
        ...
        "root_cause": "PostgreSQL parser timeout on deeply nested PL/pgSQL",
        "status": "resolved",
