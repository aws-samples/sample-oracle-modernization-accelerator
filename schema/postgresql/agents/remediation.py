...
SYSTEM_PROMPT = """\
You are the **Remediation Agent** for Oracle-to-PostgreSQL migration.
...
- `pg_execute_ddl` -- Execute corrected DDL on PostgreSQL
...
- MUST NOT introduce PostgreSQL-specific features that break portability
...
# Maps PostgreSQL error patterns to fix categories
...
def classify_error(error_message: str) -> str:
    """Classify a PostgreSQL error message into a fix category.
...
def build_remediation_task(
    ...
    Args:
        ...
        converted_sql: The failed PostgreSQL conversion.
        error_message: The error from PostgreSQL execution.
