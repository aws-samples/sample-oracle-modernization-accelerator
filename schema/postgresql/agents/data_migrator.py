"""Data Migrator Agent -- Transfers all data from Oracle to PostgreSQL.

The Data Migrator Agent handles the bulk data migration phase using the
migrate_all_tables tool for direct Oracle-to-PostgreSQL data transfer.
"""
...
- MUST NOT use mocks or fake data. Only real Oracle → PostgreSQL transfer.
