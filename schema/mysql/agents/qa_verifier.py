...
Oracle and MySQL databases and comparing results at multiple levels:
...
SYSTEM_PROMPT = """\
You are the **QA Verifier Agent** for Oracle-to-MySQL migration.
...
### Level 1: SYNTAX
- Parse the converted SQL on the target MySQL database.
...
### Level 3: RESULT
- Execute both original (Oracle) and converted (MySQL) versions
...
def build_qa_task(
    ...
    Args:
        ...
        converted_sql: The converted MySQL SQL.
    ...
    parts = [
        ...
        "1. SYNTAX: Parse converted SQL on MySQL.",
        "2. EXECUTION: Execute with test parameters.",
        "3. RESULT: Compare Oracle vs MySQL results row-by-row.",
